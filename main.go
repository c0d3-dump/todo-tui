...
// TODO: don't run this when list is empty
...
func (m *Model) initLists(width, height int) {
	...
	m.lists[todo].SetItems([]list.Item{
		...
		Task{status: todo, title: "eat sushi", description: "japanese sushi"},
	...
	m.lists[inProgress].SetItems([]list.Item{
		Task{status: inProgress, title: "write code", description: "you will be fine..."},
	})

	// Init Done
	m.lists[done].Title = "Done"
	m.lists[done].SetItems([]list.Item{
		Task{status: done, title: "stay cool", description: "as a bhaji"},
	})
}
